...
tfield gFields[] =
{
	...
	{G_FILE_ATTRIBUTE_MOUNTABLE_CAN_MOUNT,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_CAN_UNMOUNT,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_CAN_EJECT,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START_DEGRADED,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_CAN_STOP,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_CAN_POLL,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_IS_MEDIA_CHECK_AUTOMATIC,	ft_boolean},
	{G_FILE_ATTRIBUTE_MOUNTABLE_UNIX_DEVICE,	ft_numeric_32},
	{G_FILE_ATTRIBUTE_MOUNTABLE_UNIX_DEVICE_FILE,	ft_string},
	{G_FILE_ATTRIBUTE_MOUNTABLE_HAL_UDI,	ft_string},
	...
	{G_FILE_ATTRIBUTE_DOS_IS_ARCHIVE,	ft_boolean},
	{G_FILE_ATTRIBUTE_DOS_IS_MOUNTPOINT,	ft_boolean},
	{G_FILE_ATTRIBUTE_DOS_IS_SYSTEM,	ft_boolean},
	{G_FILE_ATTRIBUTE_DOS_REPARSE_POINT_TAG,	ft_numeric_32},
	...
	{G_FILE_ATTRIBUTE_FILESYSTEM_SIZE,	ft_numeric_64},
	{G_FILE_ATTRIBUTE_FILESYSTEM_FREE,	ft_numeric_64},
	{G_FILE_ATTRIBUTE_FILESYSTEM_USED,	ft_numeric_64},
	{G_FILE_ATTRIBUTE_FILESYSTEM_TYPE,	ft_string},
	{G_FILE_ATTRIBUTE_FILESYSTEM_READONLY,	ft_boolean},
	{G_FILE_ATTRIBUTE_FILESYSTEM_REMOTE,	ft_boolean},
	{G_FILE_ATTRIBUTE_GVFS_BACKEND,	ft_string},
	{G_FILE_ATTRIBUTE_SELINUX_CONTEXT,	ft_string},
	{G_FILE_ATTRIBUTE_TRASH_ITEM_COUNT,	ft_numeric_32},
	{G_FILE_ATTRIBUTE_TRASH_ORIG_PATH,	ft_string},
	{G_FILE_ATTRIBUTE_TRASH_DELETION_DATE,	ft_string},
	{G_FILE_ATTRIBUTE_RECENT_MODIFIED,	ft_datetime},
};
