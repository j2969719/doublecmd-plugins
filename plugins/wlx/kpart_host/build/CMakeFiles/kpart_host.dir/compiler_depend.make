...
kpart_host_autogen/timestamp: /home/pplupo/repos/mpv_wayland/plugins/wlx/kpart_host/CMakeLists.txt \
  CMakeFiles/4.3.1/CMakeCXXCompiler.cmake \
  CMakeFiles/4.3.1/CMakeSystem.cmake \
  kpart_host_autogen/moc_predefs.h \
...
CMakeFiles/kpart_host.dir/kpart_host_autogen/mocs_compilation.cpp.o: kpart_host_autogen/mocs_compilation.cpp \
  /home/pplupo/repos/mpv_wayland/plugins/wlx/kpart_host/src/kpartwidget.h \
  kpart_host_autogen/UVLADIE3JM/moc_kpartwidget.cpp \
  /usr/include/KF6/KCoreAddons/KPluginMetaData \
  /usr/include/KF6/KCoreAddons/kcoreaddons_export.h \
  /usr/include/KF6/KCoreAddons/kcoreaddons_version.h \
  /usr/include/KF6/KCoreAddons/kpluginmetadata.h \
...
kpart_host.wlx: /usr/lib/crti.o \
  ...
  /usr/lib/libGLX.so \
  /usr/lib/libKF6Bookmarks.so.6.25.0 \
  /usr/lib/libKF6ColorScheme.so.6.25.0 \
  /usr/lib/libKF6Completion.so.6.25.0 \
  /usr/lib/libKF6ConfigCore.so.6.25.0 \
  /usr/lib/libKF6ConfigGui.so.6.25.0 \
  /usr/lib/libKF6ConfigWidgets.so.6.25.0 \
  /usr/lib/libKF6CoreAddons.so.6.25.0 \
  /usr/lib/libKF6GuiAddons.so.6.25.0 \
  /usr/lib/libKF6ItemViews.so.6.25.0 \
  /usr/lib/libKF6JobWidgets.so.6.25.0 \
  /usr/lib/libKF6KIOCore.so.6.25.0 \
  /usr/lib/libKF6KIOFileWidgets.so.6.25.0 \
  /usr/lib/libKF6KIOGui.so.6.25.0 \
  /usr/lib/libKF6KIOWidgets.so.6.25.0 \
  /usr/lib/libKF6Parts.so.6.25.0 \
  /usr/lib/libKF6Service.so.6.25.0 \
  /usr/lib/libKF6Solid.so.6.25.0 \
  /usr/lib/libKF6WidgetsAddons.so.6.25.0 \
  /usr/lib/libKF6XmlGui.so.6.25.0 \
...
kpart_host_autogen/mocs_compilation.cpp:
